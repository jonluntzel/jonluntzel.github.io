...
Eigensystems curiously interlace individual entries and respond in surprising ways from small perturbations. For that reason, a [video](https://pages.github.com/) by x on matrices whose eigenvalues are integer-linear combinations of their entries caught my interest. I had (and have) a lot of questions about the area. So - armed with my troglodyte brain and a machine - poked around a bit.
...
<p align=center>
### [The cofactor expansion and its unrolled counterpart below relating the determinant to individual matrix entries. The intuition for how single entries in relation to others contribute to the full spectrum is often confusing.]
</p?>
...
Fig 2: Order as a graph. Free regions link their individual entries to the fixed chain but not within itself.
