...
<a href="https://github.com/Budibase/budibase/discussions/640"</a>

[https://github.com/Budibase/budibase/discussions/640]
...
<p align=center>
<p align="center">
  <img src="/imgs/poog.png" width="300"/>
</p>
<p align=center>
...
<p align="center">
<img src="/imgs/9b9.png" width="800"/> 
</p>
<p align=center>
...
<p align="center">
<img src="\imgs\iso3b3.png" width="800"/>
</p>
<p align=center>
...
<sub>Fig. 4: Example decomposition and determinant calculation. Even for big $n$ you can choose a sub-block $X$ that is an ile matrix whose factors cancel from the inner contributing $X^-1$ term and outer $\det(X)$, while the remaining components form integer-linear factors and can conserve factors of $\det(X)$. $n$-term determinants cancel $a^{(n-1)}$ terms in the denominator.<sub>

Working from a given block order you can partition it anywhere that does not interrupt a given block to get submatrices that are valid ile matrices (Fig. 4). For example, $1(23)|4$ defines 3*3 and 1*1 ile submatrices, while $1(2|3)4$ does not. It's structurally nice to permute index labels around and partition out large ile submatrices.
