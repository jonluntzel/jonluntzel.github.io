...
<p align=center>
 ...
 $$x=\frac{\prod\limits^{N}_{i=1}i}{\sum\limits^{N}_{i=1}i}$$

 $$x=\frac{\prod\limits^{N}_{i=1}\sum\limits^{N}_{i=1}i}{x}$$
 
 $$x=\frac{\prod\limits^{N}_{i=1} \sum\limits^{N}_{i=1}i}{x}$$

 $$x=\frac{\prod\limits^{N}_{i=1}(n-\sum\limits^{k}_{j=1}b_{j})}{x}$$

 $$\frac{\prod\limits^{k}_{i=1}(n-\sum_\limits^{k}_{j=1})}{x}$$
