...
Chains can neighbor free regions like in $1(23)4$ and we see the same chains and gaps $({{1,x},{y,4}})$ that enumerate 2-length selections xy from $\{2,3\}^{2}$. The analogy extends to multiple free regions or blocks - $1(23)(45)$.
...
<p align=center>
$$\begin{matrix}112358 \hdots n \\ 012345 \hdots |b|\end{matrix}$$
</p>
